...
class Scientific_App():
    ...
    def set_lmsize_var (self, lmsize_var):
        if self.ckpt_size / self.clients * lmsize_var > 512:
            self.live_migration_threshold = 512 / 12.5 / 3600
        else:
            self.live_migration_threshold = self.ckpt_size * lmsize_var / self.clients / 12.5 / 3600
