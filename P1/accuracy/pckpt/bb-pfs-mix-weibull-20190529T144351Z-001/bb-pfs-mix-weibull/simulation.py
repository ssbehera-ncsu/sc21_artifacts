...
class Simulation:
    ...
    def parse_conf(self, conf_fn, fpp, tpp, fnp):
        ...
        self.sys_fail = System_Failure(self.env, self.sys_tbf_distr, self.sys_nodes, self.node_failures, self.soft_failures, fpp, tpp, fnp)
...
if __name__ == "__main__":
    ...
    for i in range(sim_runs):
        ...
        for app in sim.apps:
            ...
            #print('restart intervals', app.comp_saved_ckpt_intvs)
