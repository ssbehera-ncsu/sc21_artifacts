...
'''
for k in sum_app_total_time.keys():
    print('[' + str(sum_app_comp_time[k]/sim_runs) + ',' + str(sum_app_ckpt_time[k]/sim_runs) + ','
          + str(sum_app_waste_time[k]/sim_runs) + ',' + str(sum_app_restart_time[k]/sim_runs) + ','
          + str(sum_app_total_time[k]/sim_runs) + ',' + str(sum_app_efficiency[k]/sim_runs) + ','
          + str(sum_app_failures[k]/sim_runs) + ',' + str(sum_app_no_of_ckpts[k] / sim_runs) + ','
          + str(sum_app_ckpt_interval[k] / sim_runs) + ',' + str(sum_app_pct_of_ckpt_2bb[k] / sim_runs) + ','
