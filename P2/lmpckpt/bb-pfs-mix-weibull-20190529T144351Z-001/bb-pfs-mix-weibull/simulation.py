...
class Simulation:
    ...
    def parse_conf(self, conf_fn, leadtime_var):
        ...
        self.sys_fail = System_Failure(self.env, self.sys_tbf_distr, self.sys_nodes, self.node_failures, self.soft_failures, self.live_migration_threshold, leadtime_var)
