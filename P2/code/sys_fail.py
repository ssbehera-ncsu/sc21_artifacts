...
class System_Failure:
    def __init__(self, env, tbf_distr, nodes, node_failures, soft_failures, live_migration_threshold, leadtime_var):
        self.env = env
        ...
        self.all_failure_leadtimes = [element * leadtime_var for element in self.all_failure_leadtimes]
